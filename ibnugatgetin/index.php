...
$tb_ibnustok = query("SELECT * FROM tb_ibnustok");

if( isset($_POST["cari"])) {
    $tb_ibnustok = cari($_POST["keyword"]);
}
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>TOKO GATGETIN IBNU</title>
    <style>
        /* Basic Page Styles */
        body {
...
<body>
    ...
    <table>
        ...
        <?php $i = 1; ?>
        <?php foreach( $tb_ibnustok as $row) :?>
        <tr>
            <td><?= $i; ?></td>
